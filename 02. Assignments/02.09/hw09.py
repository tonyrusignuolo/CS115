...
# print(letterScore('v',scrabbleScores))
# print(letterScoreLoop('v',scrabbleScores))
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Exercise 4
...
def wordScoreLoop(S, scorelist):
    ...
    x = 0
    for i in S:
        x += letterScoreLoop(i,scrabbleScores)
    return x
    pass  # TODO

print(wordScore('star',scrabbleScores))
print(wordScoreLoop('star',scrabbleScores))
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Exercise 5
...
def wordsWithScoreLambda(dct, scores):
    ...
    return map(lambda x: [x, wordScoreLoop(x,scrabbleScores)],dct)
    pass  # TODO

print(wordsWithScore(aDictionary,scrabbleScores))
print(wordsWithScoreLambda(aDictionary,scrabbleScores))
...
def wordsWithScoreLoop(dct, scores):
    ...
    L = []
    for i in dct:
      L += [[i, wordScoreLoop(i, scrabbleScores)]]  
    return L
    pass  # TODO
