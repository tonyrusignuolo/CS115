from test.test_decimal import fractions
class Fraction(object):
    '''Defines an immutable rational number with common arithmetic 
    operations.'''

    def __init__(self, numerator=0, denominator=1):
        '''Constructs a rational number (fraction) initialized to 
        zero or a user specified value.

        Args:
            numerator: the numerator of the fraction. (Default is 
            0).
            denominator: the denominator of the fraction (Default 
            is 1).

        Raises:
            ZeroDivisionError: if the user tries to construct a 
            fraction with the denominator 0.
        '''
    ...
    def __eq__(self, other):
        '''Determines if this fraction is equal to another 
        fraction.
    ...
    def __mul__(self, other):
        ...
        Returns:
            a new Fraction object resulting from the 
            multiplication
        '''
    ...
    def __lt__(self, other):
        ...
        Returns:
            True if this fraction is less than the other, False 
            otherwise
        '''
    ...
    def __ne__(self, other):
        '''Determines if this fraction is not equal to another 
        fraction.
    ...
    def __le__(self, other):
        '''Determines if this fraction is less than or equal to 
        another fraction.
        ...
        Returns:
            True if this fraction is less than or equal to the 
            other, False otherwise
        '''
        return not other < self

    def __gt__(self, other):
        '''Determines if this fraction is greater than another 
        fraction.
        ...
        Returns:
            True if this fraction is greater than the other, False 
            otherwise
        '''
        return other < self

    def __ge__(self, other):
        '''Determines if this fraction is greater than or equal to 
        another fraction.
        ...
        Returns:
            True if this fraction is greater than or equal to the 
            other, False otherwise
        '''
        return not self < other
    ...
    def __float__(self):
        ...
        # ask about double slash and floats
    ...
    def __str__(self):
        '''Gets a user-friendly string representation of the 
        fraction.
...
if __name__ == '__main__':
    ...
    print(h)
    h._Fraction__numerator = 3 #name mangling
    print(h)
